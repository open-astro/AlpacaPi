...
//
		...
		virtual	TYPE_ASCOM_STATUS	Put_Maxstep(TYPE_GetPutRequestData *reqData, char *alpacaErrMsg);
		virtual	TYPE_ASCOM_STATUS	Get_Backlash(TYPE_GetPutRequestData *reqData, char *alpacaErrMsg, const char *responseString);
		virtual	TYPE_ASCOM_STATUS	Put_Backlash(TYPE_GetPutRequestData *reqData, char *alpacaErrMsg);
		virtual	TYPE_ASCOM_STATUS	Get_Reverse(TYPE_GetPutRequestData *reqData, char *alpacaErrMsg, const char *responseString);
		virtual	TYPE_ASCOM_STATUS	Put_Reverse(TYPE_GetPutRequestData *reqData, char *alpacaErrMsg);
//
