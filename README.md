...
Once installed and running you can access the web sever and make changes to your gear where acceptable. The port to access the portal is http://ip:6800/ based on the IP of your RPi
